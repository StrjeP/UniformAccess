...
import org.uniform.demo.SimpleAveragedDataEventSource
...
class StoreComputeFromStoreDemo : EventConsumer<XnYnC> {
    ...
    fun run() {
        val s = SimpleAveragedDataEventSource()
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val demoConsumer = StoreComputeFromStoreDemo()
            demoConsumer.run()
        }
    }
}